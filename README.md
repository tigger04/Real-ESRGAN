...
This is a fork of [`xinntao/Real-ESRGAN`](https://github.com/xinntao/Real-ESRGAN). We track upstream master via `make update`. All upstream files remain functional and unmodified in spirit. Our additions live in:
...
- Homebrew formula in [`tigger04/homebrew-tap`](https://github.com/tigger04/homebrew-tap)
