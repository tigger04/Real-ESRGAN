...
def _get_version():
    """Read version from the VERSION file shipped with the package."""
...
def get_video_meta_info(video_path):
    ...
    ret['fps'] = eval(video_streams[0]['avg_frame_rate'])  # upstream convention
...
def main():
    ...
    parser.add_argument('--version', action='version', version=f'upscale-video {_get_version()}')
